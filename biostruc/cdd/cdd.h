...
static AsnValxNode avnx[87] = {
    ...
    {20,"hybrid-aligned-score" ,8,0.0,&avnx[54] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"unassigned" ,0,0.0,&avnx[56] } ,
    {20,"single-linkage" ,1,0.0,&avnx[57] } ,
    {20,"neighbor-joining" ,2,0.0,&avnx[58] } ,
    {20,"fast-minimum-evolution" ,3,0.0,&avnx[59] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"unassigned" ,0,0.0,&avnx[61] } ,
    {20,"blosum45" ,1,0.0,&avnx[62] } ,
    {20,"blosum62" ,2,0.0,&avnx[63] } ,
    {20,"blosum80" ,3,0.0,&avnx[64] } ,
    {20,"pam30" ,4,0.0,&avnx[65] } ,
...
static AsnType atx[222] = {
  ...
  {0, "elementid" ,128,2,0,1,0,0,0,0,NULL,&atx[2],NULL,0,&atx[52]} ,
...
#define CDD_BOOK_REF_celementid &at[53]
#define CDD_BOOK_REF_csubelementid &at[54]
